...
const RefreshCode = () => {
    ...
    //将验证码显示在code_img元素上
    const code_img_Login = document.getElementsByClassName('code_img_Login')[0] as HTMLElement
    code_img_Login.style.backgroundImage = `url('${code.url}')`
}
...
// 忘记密码
const forgetPasWord = () => {
    ElMessageBox.alert('请联系管理员进行密码找回', '忘记密码', {
        type: 'warning',
...
<template>
    ...
    <div id="card">
        ...
        <div class="card-right">
            ...
            <div class="footers">
                <span @click="forgetPasWord">忘记密码</span>
